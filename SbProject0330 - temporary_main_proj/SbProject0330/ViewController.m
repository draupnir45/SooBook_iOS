...
#import "SceondSectionTableViewCell.h"
#import "FirstTableViewCell.h"
//#import "SeccondTableViewCell.h"
#import "SecondCell.h"
...
@property CollcetionDataSource *collcetionDataSource;
...
- (void)viewDidLoad {
    ...
    //self.collcetionDataSource = [[CollcetionDataSource alloc] initWithSbDataArray:collectionDataArr];
    self.collcetionDataSource = [[CollcetionDataSource alloc] initWithSbDataArray:self.mainImageArray];
    self.collcetionDataSource = [[CollcetionDataSource alloc] initWithSbDataArray:self.titleLabelArray];
    self.collcetionDataSource = [[CollcetionDataSource alloc] initWithSbDataArray:self.subLabelArray];
     self.collcetionDataSource = [[CollcetionDataSource alloc] initWithSbDataArray:self.contentsArray];
    
    [self.tableView registerNib:[UINib nibWithNibName:@"FirstSectionTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"firstSection"];
    [self.tableView registerNib:[UINib nibWithNibName:@"SceondSectionTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"secondSection"];
    [self.tableView registerNib:[UINib nibWithNibName:@"SecondCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"sceondTableCell"];
    [self.tableView setBackgroundColor:[UIColor whiteColor]];
    [self.tableView setSeparatorStyle:UITableViewCellSeparatorStyleNone];
    
   
    UIImage *image = [UIImage imageNamed: @"logoForNavigation"];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    switch (section) {
        ...
        case 0:
            {
                FirstSectionTableViewCell *view = [tableView dequeueReusableCellWithIdentifier:@"firstSection"];
        ...
        default:
            {
                SceondSectionTableViewCell *view = [tableView dequeueReusableCellWithIdentifier:@"secondSection"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        [cell.firstCollectionViewCell registerNib:[UINib nibWithNibName:@"NibFirstCollectionViewCell" bundle:[NSBundle mainBundle]]forCellWithReuseIdentifier:@"nibFirstCollectionViewCell"];
        
    
        cell.firstCollectionViewCell.delegate = self;
        cell.firstCollectionViewCell.dataSource = self.collcetionDataSource;
        ...
        SecondCell *cell = [tableView dequeueReusableCellWithIdentifier:@"sceondTableCell" forIndexPath:indexPath];
        
        [cell setDataWithImagename:[NSString stringWithFormat:@"%@",[self.mainImageArray objectAtIndex:indexPath.row]]
                          mainText:[NSString stringWithFormat:@"%@",[self.titleLabelArray objectAtIndex:indexPath.row]]
                          asubText:[NSString stringWithFormat:@"%@",[self.subLabelArray objectAtIndex:indexPath.row]]];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat heightByWidthRatio = [NibFirstCollectionViewCell getImageRatioWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpeg",indexPath.item+1]]];
